                ...
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col p-5 max-w-2xl mx-auto mb-10">
                    ...
                    <label className="block mb-5">
                        ...
                        <input
                            ...
                            className="shadow border rounded py-2 px-3 form-layout mt-1 block 
                    ...
                    <label className="block mb-5">
                        ...
                        <input
                            ...
                            className="shadow border rounded py-2 px-3 form-layout mt-1 block 
                    w-full ring-yellow-500 outline-none focus:ring"
                            placeholder="john.doe@gmail.com" type="email" />
                    </label>
                    <label className="block mb-5">
                    ...
                    w-full ring-yellow-500 outline-none focus:ring" placeholder="John Doe" rows={8} />
                    </label>
...
// populates the information for the page
